    ...
    return (
        <div>
            <div className='individual-category-main'>
                    ...
                    <div><h2>{catName}</h2></div>
            
                <div><Button onClick={()=>setCategoryPopup(true)} variant="contained">Edit</Button></div>
                <div><Button variant="contained" color="error" >Delete</Button></div>
